...
echo "$Node_0_ISP_Modem_0 -> $Node_1_Switch_0 $Node_1_Switch_0 -> $Node_2_Switch_Central $Node_1_Switch_0 -> $Node_3_Router_NorthWest" | graph-easy

echo "$Node_2_Switch_Central -> $Node_4_Router_0 $Node_4_Router_0 -> $Node_5_Switch_0 $Node_5_Switch_0 -> $Node_6_Wireless_Router_0 $Node_5_Switch_0 -> $Node_7_Wireless_Router_1" | graph-easy
'@ > dot.ps1
PS C:\Users\ecs-user\Downloads>
PS C:\Users\ecs-user\Downloads> .\dot.ps1
...
+--------------------+     +-------------------------+     +-----------------------+
| Node_0_ISP_Modem_0 |     |                         |     |                       |
|   China Telecom    |     |     Node_1_Switch_0     |     | Node_2_Switch_Central |
|   GPON / Bridge    | --> |                         | --> |                       |
+--------------------+     +-------------------------+     +-----------------------+
                             |
                             |
                           ...
                           +-------------------------+
+-----------------------+     +-------------------------+     +--------------------------+     +--------------------------+
|                       |     |     Node_4_Router_0     |     |                          |     | Node_6_Wireless_Router_0 |
| Node_2_Switch_Central |     |          PPPoE          |     |     Node_5_Switch_0      |     |      Wire Repeater       |
|                       | --> | / CIDR is 172.16.0.0/12 | --> |                          | --> |        / Extender        |
+-----------------------+     +-------------------------+     +--------------------------+     +--------------------------+
                                                                |
                                                                |
                                                                v
